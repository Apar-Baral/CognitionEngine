...
def welcome_markup(*, project_root: str, initialized: bool, goal: str = "") -> str:
    lines = [
        ...
        "",
        "[bold]Copy & clipboard[/]",
        "  Terminal selection is default: drag-highlight text normally, then Ctrl+Shift+C.",
        "  App mouse mode: [dim]CE_APP_MOUSE=1[/] enables clicks/wheel; use PgUp/Dn in terminal-copy mode.",
        "  Backup file after each reply: [dim]~/.cognition/last_reply.txt[/]",
        "",
        "[bold]Scroll[/]",
        "  [dim]PgUp[/] / [dim]PgDn[/]  ·  mouse wheel when CE_APP_MOUSE=1",
        "",
        "[bold]Slash commands[/]",
